...
def get_configs():
    ...
    widgets.create_label(configPage, "Number of threaded windows:")
    numOfThreadsEntry = widgets.crete_entry(configPage, "5")

    widgets.create_label(configPage, "Fake request delay (sec):")
    ...
    errorLabel = widgets.create_label(configPage, "")
